...
class ApexParserVisitor(ParseTreeVisitor):
    ...
    def visitTriggerBlock(self, ctx:ApexParser.TriggerBlockContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#triggerBlockMember.
    def visitTriggerBlockMember(self, ctx:ApexParser.TriggerBlockMemberContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#anonymousUnit.
    def visitAnonymousUnit(self, ctx:ApexParser.AnonymousUnitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#anonymousBlock.
    def visitAnonymousBlock(self, ctx:ApexParser.AnonymousBlockContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#anonymousBlockMember.
    def visitAnonymousBlockMember(self, ctx:ApexParser.AnonymousBlockMemberContext):
        return self.visitChildren(ctx)
    ...
    def visitTriggerMemberDeclaration(self, ctx:ApexParser.TriggerMemberDeclarationContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#anonymousMemberDeclaration.
    def visitAnonymousMemberDeclaration(self, ctx:ApexParser.AnonymousMemberDeclarationContext):
        return self.visitChildren(ctx)
    ...
    def visitAccessLevel(self, ctx:ApexParser.AccessLevelContext):
        return self.visitChildren(ctx)
    ...
    def visitCoalExpression(self, ctx:ApexParser.CoalExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ApexParser#voidPrimary.
    def visitVoidPrimary(self, ctx:ApexParser.VoidPrimaryContext):
        return self.visitChildren(ctx)
    ...
    def visitLocationValue(self, ctx:ApexParser.LocationValueContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#coordinateValue.
    def visitCoordinateValue(self, ctx:ApexParser.CoordinateValueContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ApexParser#whereLogicalExpression.
    def visitWhereLogicalExpression(self, ctx:ApexParser.WhereLogicalExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#whereConditionalExpression.
    def visitWhereConditionalExpression(self, ctx:ApexParser.WhereConditionalExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#whereFieldExpression.
    def visitWhereFieldExpression(self, ctx:ApexParser.WhereFieldExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitSignedNumber(self, ctx:ApexParser.SignedNumberContext):
        return self.visitChildren(ctx)
    ...
    def visitFieldGroupByList(self, ctx:ApexParser.FieldGroupByListContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ApexParser#fieldGroupBy.
    def visitFieldGroupBy(self, ctx:ApexParser.FieldGroupByContext):
        return self.visitChildren(ctx)
    ...
    def visitSoslLiteralAlt(self, ctx:ApexParser.SoslLiteralAltContext):
        return self.visitChildren(ctx)
    ...
    def visitSoslWithClause(self, ctx:ApexParser.SoslWithClauseContext):
        return self.visitChildren(ctx)
